...
const GrowthStageSelector = ({ selected, onSelect }) => {
  const stages = [
    'Seedling', 'Tillering', 'Panicle Initiation', 'Flowering',
    'Milk Stage', 'Dough Stage', 'Maturity', 'Harvested'
  ];
  ...
  return (
    <div>
      ...
      >
        ...
        <p className="text-gray-600 mb-2">Tap to capture or upload images</p>
 ...
 */
const MonitoringForm = ({ onLogout, currentUser, showToast, onSubmissionSuccess }) => {
  // Form state
    ...
    try {
      const submissionData = {
        ...
        trait_measurements: {
          ...
          panicles_per_hill: parseInt(formData.measurements.paniclesPerHill) || 0,
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-gradient-to-r from-green-600 to-green-700 px-4 py-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-green-100 text-sm">Data Collection Form</p>
          </div>
          <button
            onClick={onLogout}
      ...
      <form onSubmit={handleSubmit} className="flex-1 p-4 pb-20">
        {/* Date of Observation */}
        <InputField label="Date of Observation" icon={Calendar} required error={errors.date}>
          <TextInput
            type="date"
            value={formData.date}
        ...
        {/* Location */}
        <InputField label="Location of Field" icon={MapPin} required error={errors.location}>
          <TextInput
        ...
        {/* Growth Stage */}
        <InputField label="Growth Stage of Rice" icon={Leaf} required error={errors.growthStage}>
          <GrowthStageSelector 
            selected={formData.growthStage} 
            onSelect={(stage) => handleInputChange('growthStage', stage)} 
          />
          {errors.growthStage && (
            <p className="text-red-600 text-sm mt-2">{errors.growthStage}</p>
          )}
        </InputField>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <TextInput
                ...
                onChange={(e) => handleMeasurementChange('culmLength', e.target.value)}
              />
            </div>
            <div>
              <label className="block text-sm text-gray-600 mb-1">
              ...
              <TextInput
                ...
                onChange={(e) => handleMeasurementChange('panicleLength', e.target.value)}
              />
            </div>
            <div>
              <label className="block text-sm text-gray-600 mb-1">
              ...
              <TextInput
                ...
                onChange={(e) => handleMeasurementChange('paniclesPerHill', e.target.value)}
              />
            </div>
            <div>
              <label className="block text-sm text-gray-600 mb-1">
              ...
              <TextInput
                ...
                onChange={(e) => handleMeasurementChange('hillsObserved', e.target.value)}
              />
            </div>
          </div>
        </InputField>
